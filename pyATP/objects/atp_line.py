# pyATP/objects/atp_line.py

class ATPLine:
    """
    Represents a single line in an ATP file, preserving its fixed-column format.
    Provides access to specific character ranges by column index.
    """
